...
class ModelVersion(Base):
    ...
    # MLflow integration
    mlflow_run_id = Column(String(100), index=True)  # Direct MLflow run ID for deployment access
    ...
    # Storage information
    storage_path = Column(String(500), nullable=False)  # Local/DVC path
    dvc_path = Column(String(500))  # DVC file path
    mlflow_model_uri = Column(String(500))  # MLflow model URI
